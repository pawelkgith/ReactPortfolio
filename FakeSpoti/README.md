...
- **Styling:** SASS (SCSS), BEM Methodology

## 🚀 Run project

Clone repo:
   ```bash
   git clone [https://github.com/pawelkgith/ReactPortfolio/tree/main/FakeSpoti.git](https://github.com/pawelkgith/tree/main/FakeSpoti)
